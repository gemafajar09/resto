...
if($_SESSION['nama_level']=="admin") {
    header("Location: _entry/_Admin/index");
}

elseif ($_SESSION['nama_level']=="waiter") {
    header("Location: _entry/_Waiter/index");
}

elseif ($_SESSION['nama_level']=="kasir") {
    header("Location: _entry/_Kasir/index");
}

elseif ($_SESSION['nama_level']=="owner") {
    header("Location: _entry/_Owner/index");
}
	...
	<div class="navbar navbar-default navbar-xs" id="navbar-second">
		...
		<div class="navbar-collapse collapse" id="navbar-second-toggle">
			<ul class="nav navbar-nav">
				<li class="active"><a href="index"><i class="icon-list3 position-left"></i> Daftar Menu</a></li>
				<li><a href="meja"><i class="icon-table position-left"></i> Daftar Meja</a></li>
				<li>
	...
	<div class="page-container">
		...
		<div class="page-content">
									...
									<div class="panel">
										<div class="panel-body">
											<div class="thumb thumb-fixed">
												<a href="_entry/assets/images/masakan/<?php echo $show['image']; ?>" data-popup="lightbox">
													<img style="width: 120; height: 120px;" src="_entry/assets/images/masakan/<?php echo $show['image']; ?>" alt="">
										...
										<div class="panel-body panel-body-accent text-center">
											<h6 class="text-semibold no-margin"><a href="#" class="text-default"><?php echo $show['nama_masakan']; ?></a></h6>
            ...
            ?>
                ...
                <li><a href="index?page=<?php echo $link_prev; ?>">&laquo;</a></li>
            <?php
            }
            ?>
            ...
            ?>
                <li <?php echo $link_active; ?>><a href="index?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
            <?php
            }
            ?>
            ...
            ?>
                <li><a href="index?page=<?php echo $link_next; ?>">&raquo;</a></li>
                <li><a href="index?page=<?php echo $jumlah_page; ?>">Last</a></li>
            <?php
            }
            ?>
								</ul>
					...
					<div class="footer text-muted">
						<p>@Copy Right |<>Waroeng Raja Sambal</a></p>
					</div>
					<!-- /footer -->
						...
						<div class="modal-dialog">
							<div class="modal-content text-center">
								<div class="modal-header">
									<h5 class="modal-title">Masukan Nama Pelanggan</h5>
								</div>
