			...
			<form action="proses/tambah_pengguna.php" method="post" enctype="multipart/form-data" id="form_tambah_pengguna">
	      		...
	      		<div class="modal-body">
	        		<div class="form-group">
						...
						<input type="text" maxlength = "30" class="form-control" name="username" id="username" placeholder="Masukan Username..." required oninvalid="this.setCustomValidity('Username Harus Di isi')" onkeypress="hack(event)" oninput="setCustomValidity('')">
	        		</div>
	        		<div class="col-sm-6">
							<label for="nama_user" class="label-control">Nama</label>
							<input type="text" maxlength = "30" class="form-control" name="nama_user" id="nama_user" placeholder="Masukan Nama..." required oninvalid="this.setCustomValidity('Nama Harus Di isi')" onkeypress="hack(event)" oninput="setCustomValidity('')">
	        			</div>
		          </div>
		      </div>
	        		<div class="form-group">
						...
						<input type="password" maxlength = "30" class="form-control" name="password" id="password" placeholder="Masukan Password..." required oninvalid="this.setCustomValidity('Password Harus Di isi')" onkeypress="hack(event)" oninput="setCustomValidity('')">
							</div>

							<div class="col-sm-6">
								<label for="konfirmasi_password" class="label-control">Konfirmasi Password</label>
						<input type="password" class="form-control" name="konfirmasi_password" id="konfirmasi_password" placeholder="Masukan Password Sekali Lagi..." required oninvalid="this.setCustomValidity('Konfirmasi Password Harus Di isi')" onkeypress="hack(event)" oninput="setCustomValidity('')">
							</div>
						</div>
					</div>
