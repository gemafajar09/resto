														...
														<div class="row">
															...
															<div class="col-md-6">
									                            ...
									                            <select class="select" name="nama_level">
										                            ...
										                            <option value="4" <?php if($nama_level=='4') {echo 'select="select"';} ?>>Dapur</option>
									                            </select>
															</div>
														</div>
													</div>
						...
						<div class="col-lg-3">
					    	...
					    	<div class="panel panel-flat">
								...
								<div class="list-group no-border no-padding-top">
									...
									<a href="#" class="list-group-item"><i class="icon-user"></i> ENO</a>
									<a href="#" class="list-group-item"><i class="icon-city"></i> Raja Sambal</a>
