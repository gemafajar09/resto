...
<?php
	$query = $conn->query("SELECT * FROM pesanan INNER JOIN meja ON pesanan.no_meja = meja.id_meja WHERE pesanan.status_pesanan = 'menunggu dimasak'");
...
?>
								...
								<li>
									<a href="#"><i class="icon-stack2"></i> <span>Entri Pesanan</span><span class="label bg-blue-400"><?php echo $hitung;?></span></a>
									<ul>
										<li><a href="list_pesanan">Pesanan</a></li>
									</ul>
								</li>
