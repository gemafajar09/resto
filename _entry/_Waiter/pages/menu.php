...
?>
								...
								<li>
									<a href="#"><i class="icon-stack2"></i> <span>Entri Order</span><span class="label bg-blue-400"><?php echo $hitung;?></span></a>
									<ul>
										<li><a href="list_pesanan">Pemesanan</a></li>
									</ul>
								</li>
								<li>
									<a href="#"><i class="icon-stack2"></i> <span>Entri Transaksi</span><span class="label bg-blue-400"><?php echo $hitung1;?></span></a>
									<ul>
