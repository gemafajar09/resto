                            ...
                            ?>
									...
									<div class="panel-body">
										...
										<div class="form-group">
											...
											<input name="password_lama" type="password" onkeypress="hack(event)" placeholder="Masukan Password Lama" class="form-control" required="">
										</div>

										<div class="form-group">
											<label for="password_lama">Password Baru</label>
											<input name="password_baru" type="password" onkeypress="hack(event)" placeholder="Masukan Password Baru" class="form-control" required="">
										</div>
