												...
												<form action="proses/update_profile?id_user=<?php echo $id_user; ?>" method="post" enctype="multipart/form-data">
													...
													<div class="form-group">
														<div class="row">
															...
															<div class="col-md-6">
									                            <label>Level</label>
									                            <select class="select" name="nama_level">
									                                <option value="" disabled select>Pilih Level</option>
										                            <option value="2" <?php if($nama_level=='2') {echo 'select="select"';} ?>>Waiter</option>
									                            </select>
															</div>
														</div>
													</div>
						...
						<div class="col-lg-3">
					    	...
					    	<div class="panel panel-flat">
								...
								<div class="list-group no-border no-padding-top">
									...
									<a href="#" class="list-group-item"><i class="icon-user"></i> Skrpsi</a>
									<a href="#" class="list-group-item"><i class="icon-city"></i> ---</a>
									<div class="list-group-divider"></div>
									<a href="#" class="list-group-item"><i class="icon-phone2"></i> 08774873447</a>
									<a href="#" class="list-group-item"><i class="icon-info3"></i> Radja Sambal</a>
								</div>
							</div>
							<!-- /navigation -->
