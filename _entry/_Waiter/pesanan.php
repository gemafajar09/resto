...
?>          
                                ...
                                <li class="media panel panel-body stack-media-on-mobile">
                                    ...
                                    <div class="media-body">
                                        <h6 class="media-heading text-semibold">
                                            <a href="cart?act=add&amp;id_masakan=<?php echo $show['id_masakan']; ?> &amp;ref=pesanan"><?php echo $show['nama_masakan']; ?></a>
                                        </h6>
                ...
                <div class="panel">
                    <div class="panel-body">
                        ...
                        <div class="blog-post">
                            ...
                            <div class="media">
                                <div class="panel-body">
                                    <form action="proses/pesanan" method="post">
            ...
            if (isset($_SESSION['items1'])){
                foreach ($_SESSION['items1'] as $key => $val) {
                    ...
                    ?>
                    <input class="form-control" type="text" name="nama" placeholder="Masukan Nama Pelanggan" required>
    ...
    //mysql_select_db($database_conn, $conn);
                      ...
                      <tr>
                        ...
                        <td><input type="text" name="keterangan" class="form-control" placeholder="Jika Ada Catatan"></td>
...
?>
                    ...
                    <div class="footer text-muted">
                        &copy; 2019. <a href="#">Raja Sambal</a> by <a href="http://goresto.epizy.com" target="_blank">Eno</a>
                    </div>
                    <!-- /footer -->
