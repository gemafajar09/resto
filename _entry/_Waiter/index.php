							...
							<div class="thumbnail no-padding">
								<div class="thumb">
									...
									<div class="caption-overflow">
										<span>
											<a href="cart_meja?act1=add&amp;id_meja=<?php echo $show['id_meja'];?> &amp;ref1=pesanan" title="PESAN MEJA" class="btn bg-success-400 btn-icon btn-xs legitRipple"><i class="icon-cart"></i></a>
										</span>
									</div>
								</div>
...
<?php } ?>
		...
		<!-- /page content -->
				...
				<div class="footer text-muted">
                        &copy; 2019. <a href="#">Raja Sambal</a> by <a href="" target="_blank">Skripsi </a>
                </div>
