        ...
        <script>
            function tampilkanData(tanggal){
                ...
                <?php
                    ...
                    $query = $conn->query("SELECT * FROM pesanan WHERE tanggal = DATE('$tanggal') ");
                                        ...
                                        <ul class="icons-list">
                                            <li class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <li><a class="lihat_pesanan klik" data-toggle="modal" data-target="#mymodal_lihat_pesanan" value="<?php echo $x['id_pesanan'];?>"> Tambah Pesanan</a></li>
                                                </ul>
                                            </li>
                                        </ul>
                                    </td>
