	      			...
	      			<div class="form-group">
						<div class="row">
							<div class="col-sm-6">
								...
								<input type="text" maxlength = "20" class="form-control" name="username" id="username" value="<?php echo $data['username'];?>" onkeypress="hack(event)" required oninvalid="this.setCustomValidity('username Harus Di isi')" oninput="setCustomValidity('')">
							</div>
							
							<div class="col-sm-6">
								<label for="nama_user" class="label-control">Nama User</label>
								<input type="text" maxlength="20" class="form-control" name="nama_user" id="nama_user" value="<?php echo $data['nama_user'];?>" onkeypress="hack(event)" required oninvalid="this.setCustomValidity('Nama User Harus Di isi')" oninput="setCustomValidity('')">
							</div>
					...
					<div class="form-group">
						<div class="row">
							<div class="col-sm-6">
								...
								<input type="password" class="form-control" name="password" id="password" value="<?php echo $data['password'];?>" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength = "20" required oninvalid="this.setCustomValidity('Password Harus Di isi')" oninput="setCustomValidity('')">
							</div>

							<div class="col-sm-6">
								<label for="email" class="label-control">Email</label>
								<input type="email" class="form-control" name="email" id="email" value="<?php echo $data['email'];?>" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength = "20" onkeypress="hack(event)" onkeypress="hack(event)" required oninvalid="this.setCustomValidity('Email Harus Di isi')" oninput="setCustomValidity('')">
							</div>
