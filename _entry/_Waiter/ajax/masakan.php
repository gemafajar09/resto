			...
			<form action="proses/tambah_menu.php" method="post" enctype="multipart/form-data" id="form_tambah_masakan">
	      		...
	      		<div class="modal-body">
	      			<div class="form-group">
						...
						<input type="text" maxlength = "20" class="form-control" name="nama_masakan" id="nama_masakan" placeholder="Masukan Nama Masakan..." onkeypress="hack(event)" required oninvalid="this.setCustomValidity('Nama Masakan Harus Di isi')" oninput="setCustomValidity('')">
							</div>
					...
					<div class="form-group">
						<div class="row">
							<div class="col-sm-6">
								...
								<input type="number" maxlength="10" class="form-control" name="harga" id="harga" placeholder="Masukan Harga..." oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" onkeypress="hack(event)" required oninvalid="this.setCustomValidity('Harga Harus Di isi')" oninput="setCustomValidity('')">
							</div>
