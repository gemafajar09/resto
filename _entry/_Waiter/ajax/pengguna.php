...
?>
                    ...
                    <tbody>
                      <?php
                      $no = 1;
                      foreach($db->show_pengguna2() as $x){
                      ?>
                      <tr>
                        <td><?php echo $no++; ?></td>
			...
			<form action="proses/tambah_pengguna.php" method="post" enctype="multipart/form-data" id="form_tambah_pengguna">
	      		...
	      		<div class="modal-body">
	        		<div class="form-group">
						...
						<input type="text" maxlength = "20" class="form-control" name="username" id="username" placeholder="Masukan Username..." onkeypress="hack(event)" required oninvalid="this.setCustomValidity('Username Harus Di isi')" oninput="setCustomValidity('')">
	        		</div>
	        		<div class="col-sm-6">
							<label for="nama_user" class="label-control">Nama</label>
							<input type="text" maxlength = "20" class="form-control" name="nama_user" id="nama_user" placeholder="Masukan Nama..." onkeypress="hack(event)" required oninvalid="this.setCustomValidity('Nama Harus Di isi')" oninput="setCustomValidity('')">
	        			</div>
		          </div>
		      </div>
	        		<div class="form-group">
						...
						<input type="password" maxlength = "20" class="form-control" name="password" id="password" placeholder="Masukan Password..." onkeypress="hack(event)" required oninvalid="this.setCustomValidity('Password Harus Di isi')" oninput="setCustomValidity('')">
							</div>

							<div class="col-sm-6">
								<label for="konfirmasi_password" class="label-control">Konfirmasi Password</label>
						<input type="password" maxlength="20" class="form-control" name="konfirmasi_password" id="konfirmasi_password" onkeypress="hack(event)" placeholder="Masukan Password Sekali Lagi..." required oninvalid="this.setCustomValidity('Konfirmasi Password Harus Di isi')" oninput="setCustomValidity('')">
							</div>
						</div>
					</div>
	        		...
	        		<div class="row">
	        			<div class="col-sm-6">
							...
							<input type="email" maxlength = "30" class="form-control" name="email" id="email" placeholder="Masukan Email..." onkeypress="hack(event)" required oninvalid="this.setCustomValidity('Email Harus Di isi')" oninput="setCustomValidity('')">
			        	</div>
			        	<div class="col-sm-6">
		                <label for="id_kategori">Level</label required>
		                    ...
		                    <?php
		                    include "../koneksi.php";
		                    $query = mysqli_query($conn, "SELECT * from level where nama_level='waiter'");
