			...
			<form action="proses/tambah_pengguna.php" method="post" enctype="multipart/form-data" id="form_tambah_pengguna">
	      		...
	      		<div class="modal-body">
	        		...
	        		<div class="form-group">
						...
						<input type="password" maxlength="20" class="form-control" name="konfirmasi_password" id="konfirmasi_password" placeholder="Masukan Password Sekali Lagi..." required oninvalid="this.setCustomValidity('Konfirmasi Password Harus Di isi')" onkeypress="hack(event)" oninput="setCustomValidity('')">
							</div>
						</div>
					</div>
