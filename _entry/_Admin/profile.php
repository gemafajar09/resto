...
<!-- Page header -->
				...
				<div class="profile-cover">
					<div class="profile-cover-img" style="background-image: url(../assets/images/unnamed.png)"></div>
					<div class="media">
<?php
...
<?php echo $data['nama_user']; ?>
				    			...
				    			<small class="display-block"><?php echo $data['id_level']; ?></small>				    		
				    		</h1>
						</div>
<?php } ?>
					</div>
												...
												<form action="proses/update_profile?id_user=<?php echo $id_user; ?>" method="post" enctype="multipart/form-data">
													<div class="form-group">
														<div class="row">
															<div class="col-md-6">
																...
																<input type="text" maxlength="15" name="username" onkeypress="hack(event)" value="<?php echo $username; ?>" class="form-control">
															</div>
															<div class="col-md-6">
																<label>Nama User</label>
																<input type="text" maxlength="15" name="nama_user" onkeypress="hack(event)" value="<?php echo $nama_user; ?>" class="form-control">
															</div>
														</div>
													</div>
													...
													<div class="form-group">
														<div class="row">
															<div class="col-md-6">
																<label>Email</label>
																<input type="email" maxlength="20" name="email" onkeypress="hack(event)" value="<?php echo $email; ?>" class="form-control">
															</div>
															<div class="col-md-6">
									                            <label>Level</label>
									                            <select class="select" name="id_level">
									                                <option value="" disabled selected>Pilih Level</option>
										                            <option value="1" <?php if($id_level=='1') {echo 'selected="selected"';} ?>>Admin</option>
										                            <option value="3" <?php if($id_level=='3') {echo 'selected="selected"';} ?>>Kasir</option>
										                            <option value="2" <?php if($id_level=='2') {echo 'selected="selected"';} ?>>Waiter</option>
										                            <option value="4" <?php if($id_level=='4') {echo 'selected="selected"';} ?>>Owner</option>
									                            </select>
															</div>
														</div>
													</div>
